...
export default function GraffitiGalleryTab({ onSwitchToStudio }: Props) {
    ...
    <div className="container mx-auto py-8 px-4 max-w-6xl">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            Creations from the Graffiti Studio community
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <Button size="sm" onClick={onSwitchToStudio}>
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <Button onClick={onSwitchToStudio}>Open Studio</Button>
        </div>
      ) : (
